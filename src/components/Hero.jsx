...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-28 sm:pt-32 pb-20 bg-gradient-to-b from-slate-950 to-slate-900 text-white">
      <Parallax strength={60} className="absolute -top-40 -right-40 h-[520px] w-[520px] rounded-full bg-blue-600/20 blur-3xl" />
      <Parallax strength={30} className="absolute top-1/2 -left-40 h-[520px] w-[520px] rounded-full bg-indigo-600/20 blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 ring-1 ring-white/20 text-xs font-medium mb-4">
              <span className="h-2 w-2 rounded-full bg-blue-400 animate-pulse" /> En tiempo real
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <a href="#pricing" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold shadow-lg shadow-blue-500/20 transition-transform hover:-translate-y-0.5">
                Probar gratis
                <ArrowRight className="h-5 w-5" />
              </a>
              <a href="#demo" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white/10 hover:bg-white/15 ring-1 ring-white/20 transition-transform hover:-translate-y-0.5">
          ...
          >
            <motion.div
              className="absolute -inset-4 bg-gradient-to-tr from-blue-600/20 to-indigo-600/20 rounded-3xl blur-2xl"
              animate={{ opacity: [0.6, 0.9, 0.6] }}
              transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
            />
            <motion.div
              className="relative rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm p-2 shadow-2xl"
              animate={{ y: [0, -8, 0] }}
              ...
              <div className="aspect-[16/10] rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 p-5">
                <div className="h-full w-full rounded-xl bg-slate-900/60 ring-1 ring-white/10 p-5 grid grid-rows-6 gap-3">
                  ...
                  <div className="row-span-5 grid grid-cols-12 gap-3">
                    <motion.div className="col-span-8 rounded-lg bg-white/5 ring-1 ring-white/10 p-4"
                    ...
                    <div className="col-span-4 space-y-3">
                      <motion.div className="h-14 rounded-lg bg-white/5 ring-1 ring-white/10"
                        initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.05 }}
                      />
                      <motion.div className="h-24 rounded-lg bg-white/5 ring-1 ring-white/10"
